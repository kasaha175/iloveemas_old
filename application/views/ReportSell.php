...
<td class="action-buttons">
                                    <a href="#" class="btn btn-danger btn-circle btn-sm" title="Delete" onclick="deleteTransaction(<?= $a->t_id ?>, '<?=$a->t_no_order?>', 'sell')">
                                        <i class="fas fa-trash-alt"></i>
                                    </a>
                                    <a href="#" class="btn btn-info btn-circle btn-sm" title="Detail" onclick="openDetailModal(<?= $a->t_id ?>, 'sell')">
        ...
        <div class="modal-content glass-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="transactionDetailModalLabel">
                    ...
                    <span id="modalTransactionType" class="badge badge-info ml-2">SELL</span>
                </h5>
...
function openDetailModal(transactionId, type) {
    ...
    // Debug: log the URL
    console.log('Fetching from: ' + apiUrl + '?id=' + transactionId);
