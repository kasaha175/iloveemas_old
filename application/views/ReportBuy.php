                        ...
                        <?php $no=0; foreach($data as $a){ $no++; ?>
                            <tr>
                                ...
                                <td class="action-buttons">
                                    ...
                                    <a href="<?=base_url()?>report/buy-print/<?=$a->t_id?>/" class="btn btn-success btn-circle btn-sm" title="Print">
                                        <i class="fas fa-print"></i>
                                    </a>
                                    <a href="<?=base_url()?>report/buy/<?=$a->t_id?>/" class="btn btn-info btn-circle btn-sm" title="Detail">
