                                        ...
                                        <table style="overflow:scroll; display:block;"  class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <?php $no=0; foreach($data as $a){ $no++; ?>
                                                <tr>
                                                    ...
                                                    <a href="<?=base_url()?>report/buy-print/<?=$a->t_id?>/" class="btn btn-success btn-circle btn-sm mr-2"><i class="fas fa-print"></i>
                                                    <a href="<?=base_url()?>report/buy/<?=$a->t_id?>/" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-info"></i>
                                                     </td>
                                                    <td><?=$a->t_no_order?></td>
                                                    <td><?=$a->t_status?></td>
