...
<div class="col-md-12" style="margin-top:110px;">
    <div style="color:#fff;margin-top:-30px;">
        ...
        <a style="color:#fff;text-decoration:none;"
            href=""><?= ucwords(str_replace('-', ' ', $this->input->get("key"))) ?></a>
    </div>
    ...
    <div class="col-md-12" style="padding:0px 350px;">
        <div class="row">
                ...
                <form action="<?= base_url() ?>archive/sell/save/" id="myForm">
                    ...
                    <div class="form-group text-center">
                        ...
                        switch ($this->input->get("key"))
                        {
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bordering"><input class="input-box" type="number" step="any"
                                                    name="f_nol5" required value="<?php echo $f_nol5; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">1 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_1"
                                                    required value="<?php echo $f_1; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">2 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_2"
                                                    required value="<?php echo $f_2; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">2.5 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any"
                                                    name="f_2_coma_5" required value="<?php echo $f_2_coma_5; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">3 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_3"
                                                    required value="<?php echo $f_3; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">5 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_5"
                                                    required value="<?php echo $f_5; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">10 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_10"
                                                    required value="<?php echo $f_10; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">25 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_25"
                                                    required value="<?php echo $f_25; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">50 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_50"
                                                    required value="<?php echo $f_50; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">100 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_100"
                                                    required value="<?php echo $f_100; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">250 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_250"
                                                    required value="<?php echo $f_250; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">500 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f_500"
                                                    required value="<?php echo $f_500; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">1000 Gr</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any"
                                                    name="f_1000" required value="<?php echo $f_1000; ?>"></td>
                                        </tr>
                            ...
                            case "material-au":
                                ?>
                                <input type="number" step="any" name="value" required class="form-control"
            ...
            <div class="col-md-12 mt-3 text-center">
                ...
                <a href="<?= base_url() ?>archive/sell/?key=<?= $this->input->get("key") ?>&type=change"
                    class="btn btn-warning btn-icon-split btn-lg">
                    <span class="icon text-white-50">
                        <i class="fas fa-arrow-left"></i>
                    </span>
