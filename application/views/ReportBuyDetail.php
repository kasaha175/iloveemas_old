...
<div style="color:#fff;margin-top:-30px;">
        ...
        > 
        <a style="color:#fff;text-decoration:none;" href="<?=base_url()?>report/buy/">Buy</a> 
        > 
        <a style="color:#fff;text-decoration:none;" href=""><?=$title?></a> 
    </div>
    <h3 class="text-center" style="color:#fff">REPORT</h3>
    <h3 class="text-center" style="color:#fff">Transaction Buy <?=$title?></h3>
    <br>
    <div class="col-md-12" style="padding:0px 150px;">
        <div class="row">
            ...
            Total Price
                ...
                <a href="<?=base_url()?>report/buy/" class="btn btn-primary btn-icon-split btn-lg">
