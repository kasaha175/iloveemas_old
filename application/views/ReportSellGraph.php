...
<div class="col-md-12 report-detail-container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb glass-breadcrumb">
            ...
            <li class="breadcrumb-item active">Sell Graph</li>
        </ol>
    </nav>
    
    <!-- Page Title -->
    <h3 class="page-title">REPORT</h3>
    <h3 class="page-subtitle">Transaction Sell Graph</h3>
    ...
    <div class="col-md-12 mt-4">
        <div class="card glass-card">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-chart-line"></i> Transaction Data</h6>
            </div>
            <div class="card-body">
