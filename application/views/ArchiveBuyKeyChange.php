                                    ...
                                    { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="c"
                                                    required value="<?= $d->c ?>"></td>
                                        </tr>
                                        <tr style="display: none">
                                            <td class="bordering">lm baru</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="d"
                                                    required value="<?= $d->d ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">lm retro</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="e"
                                                    required value="<?= $d->e ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">cust. profesional</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="f"
                                                    required value="<?= $d->f ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">Pembelian UBS</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any" name="g"
                                                    required value="<?= $d->g ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">Gold Bar 99</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any"
                                                    name="gb_99" required value="<?= $d->gb_99 ?>"></td>
                                        </tr>
                                        <tr>
                                            <td class="bordering">Gold Bar 99,9</td>
                                            <td class="bordering"><input class="input-box" type="number" step="any"
                                                    name="gb_99_9" required value="<?= $d->gb_99_9 ?>"></td>
                                        </tr>
                                    <?php }
                                    else if ($this->input->get("key") == "rti-pt")
                                    { ?>
                                            <tr>
                                                ...
                                                <td class="bordering">Pt</td>
                                                <td class="bordering"><input class="input-box" type="number" step="any"
                                                        name="aa" required value="<?= $dd->a ?>"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="bordering">Pd</td>
                                                <td class="bordering"><input class="input-box" type="number" step="any"
                                                        name="bb" required value="<?= $dd->b ?>"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="bordering">Rh</td>
                                                <td class="bordering"><input class="input-box" type="number" step="any"
                                                        name="cc" required value="<?= $dd->c ?>"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="bordering">Ir</td>
                                                <td class="bordering"><input class="input-box" type="number" step="any"
                                                        name="dd" required value="<?= $dd->d ?>"></td>
                                            </tr>
                                    <?php }
                                    else if ($this->input->get("key") == "rti-ag")
                                    { ?>
