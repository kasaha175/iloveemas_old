    ...
    <div class="form-card">
        <form action="<?=base_url()?>archive/buy/save/" id="myForm">
                    ...
                    <div class="lm-table-wrapper">
                        <table class="glass-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Material AU</td>
                                    <td><input class="input-box" type="number" step="any" name="c" required value="<?=$d->c?>"></td>
                                </tr>
                                <tr style="display:none">
                                    <td>LM Baru</td>
                                    <td><input class="input-box" type="number" step="any" name="d" required value="<?=$d->d?>"></td>
                                </tr>
                                <tr>
                                    <td>LM Retro</td>
                                    <td><input class="input-box" type="number" step="any" name="e" required value="<?=$d->e?>"></td>
                                </tr>
                                <tr>
                                    <td>Cust. Profesional</td>
                                    <td><input class="input-box" type="number" step="any" name="f" required value="<?=$d->f?>"></td>
                                </tr>
                                <tr>
                                    <td>Pembelian UBS</td>
                                    <td><input class="input-box" type="number" step="any" name="g" required value="<?=$d->g?>"></td>
                                </tr>
                                <tr>
                                    <td>Gold Bar 99</td>
                                    <td><input class="input-box" type="number" step="any" name="gb_99" required value="<?=$d->gb_99?>"></td>
                                </tr>
                                <tr>
                                    <td>Gold Bar 99,9</td>
                                    <td><input class="input-box" type="number" step="any" name="gb_99_9" required value="<?=$d->gb_99_9?>"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="lm-table-wrapper">
                        <table class="glass-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>k24 (99.9)</td>
                                    <td><input class="input-box" type="number" step="any" name="h" required value="<?=$d->h?>"></td>
                                </tr>
                                <tr>
                                    <td>k24 (99)</td>
                                    <td><input class="input-box" type="number" step="any" name="a" required value="<?=$d->a?>"></td>
                                </tr>
                                <?php for($i=23; $i>=2; $i--): ?>
                                <tr>
                                    <td>K<?=$i?></td>
                                    <td><input class="input-box" type="number" step="any" name="k<?=$i?>" required value="<?=isset($d) ? ($d->{"k{$i}"} ?? '') : ''?>"></td>
                                </tr>
                                <?php endfor; ?>
                            </tbody>
                        </table>
                        ...
                        <table class="glass-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input class="input-box" type="number" step="any" name="potongan_lm[<?=$tahun_mulai;?>]" required value="<?=$potongan_lm[$tahun_mulai]?>"></td>
                                </tr>
                    ...
                    <div class="lm-table-wrapper">
                        <table class="glass-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Pd</td>
                                    <td><input class="input-box" type="number" step="any" name="b" required value="<?=$d->b?>"></td>
                                </tr>
                                <tr>
                                    <td>Rh</td>
                                    <td><input class="input-box" type="number" step="any" name="c" required value="<?=$d->c?>"></td>
                    ...
                    <div class="lm-table-wrapper">
                        <table class="glass-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Pt</td>
                                    <td><input class="input-box" type="number" step="any" name="aa" required value="<?=$dd->a?>"></td>
                                </tr>
                                <tr>
                                    <td>Pd</td>
                                    <td><input class="input-box" type="number" step="any" name="bb" required value="<?=$dd->b?>"></td>
                                </tr>
                                <tr>
                                    <td>Rh</td>
                                    <td><input class="input-box" type="number" step="any" name="cc" required value="<?=$dd->c?>"></td>
                                </tr>
                                <tr>
                                    <td>Ir</td>
                                    <td><input class="input-box" type="number" step="any" name="dd" required value="<?=$dd->d?>"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="form-actions">
                <a href="<?=base_url()?>archive/buy/?key=<?=$this->input->get('key')?>" class="btn btn-secondary btn-lg">
