    ...
    <div class="form-card">
        <form action="<?=base_url()?>archive/sell/save/" id="myForm">
                    ...
                    <div class="lm-table-wrapper">
                        <table class="glass-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$value->size?> Gr</td>
                                    <td><input class="input-box" type="number" step="any" name="configMaterial[<?=$value->id?>]" required value="<?=$value->potongan?>"></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <div class="form-actions">
                <a href="<?=base_url()?>archive/sell/?key=<?=$this->input->get('key')?>" class="btn btn-secondary btn-lg">
