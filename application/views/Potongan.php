...
<div class="col-md-12" style="margin-top:110px;">
    <div style="color:#fff;margin-top:-30px;">
        ...
        > 
        <a style="color:#fff;text-decoration:none;" href="">Master  Potongan</a> 
    </div>
    <h3 class="text-center" style="color:#fff">MASTER</h3>
    <h3 class="text-center" style="color:#fff">Master Potongan</h3>
    <br>
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button"
                                ...
                                <h6 class="m-0 font-weight-bold text-primary"> Potongan Data </h6>
                            </a>
                            ...
                            <div class="collapse show" id="collapseCardExample" style="">
                                <div class="card-body">
                                <a href="<?= base_url('master/addpotongan') ?>" class="text-info float-right mb-2">
                                    <span class="text"><span class="fas fa-user-plus"></span> Add Potongan</span>
                                </a>
                                        ...
                                        <table style="overflow:scroll; width: 100%;"  class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="min-width:100px;">Harga Buy</th>
                                                    <th style="min-width:100px;">Harga Sell</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($potongan as $key => $value): ?>
                                                    <tr>
                                                        <td><?=$key+1?></td>
                                                        <td>
                                                            <a href="<?=base_url()?>master/detailPotongan/<?=$value->id?>/" class="btn btn-primary btn-circle btn-sm mr-2"><i class="fas fa-info"></i>
                                                            <a href="<?=base_url()?>master/deletePotongan/<?=$value->id?>/" onclick="return confirm('Apakan Anda yakin?');" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i>
                                                        </td>
                                                        <td>
                                                            <?= $value->nama ?>
                                                        </td>
