...
<div style="color:#fff;margin-top:-30px;">
        ...
        > 
        <a style="color:#fff;text-decoration:none;" href="">Archive</a> 
    </div>
       
        <h3 class="text-center" style="color:#fff">ARCHIVE</h3>
    
    <br>
    <div class="col-md-12" style="padding:0px 350px;">
        <div class="row">
            <div class="col-md-6" style="padding:10px 10px">
                <a href="<?=base_url()?>archive/buy/" class="btn btn-lg btn-custom menu-box">
                    <span class="text">BUY</span>
                </a>
            </div>
            <div class="col-md-6" style="padding:10px 10px">
                <a href="<?=base_url()?>archive/sell/" class="btn btn-lg btn-custom menu-box">
