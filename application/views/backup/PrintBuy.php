		...
		<div style="padding:45px;margin:0px;" id="printNow">
			<div style="width:100%">
				...
				<div style="padding-right:5px; width:50%; display:inline-block;vertical-align:text-top;margin-top:10px;">
					<div style="border:1px #000 solid; min-height:190px;">
				...
				<div style="padding-right:5px; padding-top:10px;width:48.3%; display:inline-block;vertical-align:text-top;">
					...
					<div>
						<div style="padding-right:5px; width:48%; display:inline-block;">
							...
							<div style="text-align:center; min-height:45px; padding-top:18px; padding-bottom:30px; border-bottom:1px #000 solid;border-left:1px #000 solid;border-right:1px #000 solid;border-bottom:1px #000 solid"><p style="padding-top:5px;"><?= date('Y-m-d', strtotime($a->t_date_created)) ?></p></div>
						</div>
						<div style="width:49%; display:inline-block;">
							...
							<div style="text-align:center; min-height:45px; padding-top:18px; padding-bottom:30px; border-bottom:1px #000 solid;border-left:1px #000 solid;border-right:1px #000 solid;border-bottom:1px #000 solid"><p style="padding-top:5px;"><?= $a->t_no_order ?></p></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div style="width:100%;margin-top:0px;">
				...
				<table style="padding-right:5px; width:100%; display:inline-block;vertical-align:text-top;margin-top:10px;">
					<tr>
