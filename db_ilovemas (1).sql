...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Apr 2021 pada 14.48
...
(2, '<span style=\"font-size: 9px;\">1. Barang yang sudah dibeli/dijual merupakan barang yang sudah mendapatkan persetujuan untuk dilakukan transaksi dan tidak dapat dikembalikan.</span>', 1),
(3, '<span style=\"font-size: 9px;\">2. Bahwa dengan ini customer menyatakan barang yang diserahkan untuk dijual/dibeli merupakan milik customer dan /atau kepemilikan sebagaimana pasal 1977 KUHPerdata, dan /atau milik pemberian kuasa atas barang yang dijual/dibeli kepada customer, dan dengan ini menyatakan menjamin (perhiasan / logam mulia) tersebut bukan berasal dari hasil kejahatan, bukan barang hasil curian, penipuan, tidak dalam sengketa dan /atau sita jaminan.</span>', 2),
(4, '<span style=\"font-size: 9px;\">3. Bahwa dalam hal customer tidak bisa menunjukan dokumen-dokumen terkait asal perolehan dan/atau kepemilikan atas barang (perhiasan/Logam Mulia) yang ditransaksikan, dengan ini menyatakan atas hal tersebut bukan disebabkan oleh karena adanya unsur kejahatan ataupun pelanggaran atas ketentuan hukum yang berlaku.</span>', 3),
(5, '<span style=\"font-size: 9px;\">4. Tidak menerima penjualan/pembelian untuk anak dibawah umur 18 tahun, kecuali dengan disertai surat lengap dan /atau disertai dengan persetujuan orang tua / wali secara tertulis.</span>', 4),
(6, '<span style=\"font-size: 9px;\">5. Jika kemudian hari, ternyata barang (perhiasan / logam mulia) tersebut diketahui didapat dari hasil curian, penipuan, penggelapan dan lain - lain. maka atas hal tersebut sepenuhnya menjadi tanggung jawab customer secara hukum pidana atau perdata.</span> ', 5),
(7, '<span style=\"font-size: 9px;\">6. Customer telah membaca, memahami dan menyetujui terkait ketentuan - ketentuan yang sudah ditetapkan.</span>', 6);
...
--
ALTER TABLE `tb_memo`
  MODIFY `tm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
